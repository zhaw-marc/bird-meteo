...
st.markdown("Scientific summary generated by Google Gemini 2.5 Flash based on your analysis results.")
...
if not api_key:
    ...
    st.info("You can get a free API key from Google AI Studio (aistudio.google.com).")
    st.stop()
